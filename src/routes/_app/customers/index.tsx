...
function CustomersList() {
  ...
  const columns: Column<Customer>[] = [
    ...
    { key: "tariff", header: "Tariff", accessor: (r) => <StatusBadge status="Active" className="!bg-info-soft !text-info">{r.tariff as any}</StatusBadge> as any, sortValue: (r) => r.tariff },
