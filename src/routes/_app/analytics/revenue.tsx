  ...
  return (
    <>
      ...
      <div className="mb-6 grid gap-4 md:grid-cols-4">
        <KpiCard label="YTD Revenue" value="₹48.72 Cr" trend={{ value: 12.4 }} variant="gradient" />
        <KpiCard label="Avg ARPU" value="₹2,890" trend={{ value: 3.6 }} />
        <KpiCard label="Collection Eff." value="94.6%" trend={{ value: 1.8 }} />
        <KpiCard label="Outstanding" value="₹3.84 Cr" trend={{ value: -5.6 }} />
      </div>
      <div className="grid gap-4 lg:grid-cols-2">
        ...
        <div className="rounded-xl border bg-card p-5 shadow-card">
          ...
          <TrendLine data={revenueTrend} xKey="month" series={[{ key: "collected", name: "Collected", color: "var(--color-accent)" }]} height={220} />
        </div>
      </div>
    </>
  );
